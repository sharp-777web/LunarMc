    ...
    <nav className="fixed top-0 left-0 right-0 z-50 glass-card">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between h-16">
        ...
        <div className="hidden md:flex items-center gap-3">
          <a href="https://discord.gg/qkKaURzz3" target="_blank" rel="noopener noreferrer" className="text-sm bg-[hsl(235,86%,65%)] text-white px-4 py-2 rounded-lg hover:opacity-90 transition-opacity flex items-center gap-2">
            Discord
          </a>
        </div>
      ...
      {open && (
        <div className="md:hidden px-4 pb-4 flex flex-col gap-3">
          ...
          <a href="https://discord.gg/qkKaURzz3" target="_blank" rel="noopener noreferrer" className="text-sm bg-[hsl(235,86%,65%)] text-white px-4 py-2 rounded-lg w-full text-center">Discord</a>
        </div>
      )}
    </nav>
  );
